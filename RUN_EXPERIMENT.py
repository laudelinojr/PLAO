...
COMANDO.insert(1,'ssh root@10.159.205.6 '+ "'"+'ps -ef | grep "PLAO.py" | awk '+"'"+'{print $2}'+"'"+'; cd /opt/PLAO; git pull; python3 PLAO_client.py 10.159.205.10 openstack1 10.159.205.6 > /dev/null 2>&1 &' +"'")
