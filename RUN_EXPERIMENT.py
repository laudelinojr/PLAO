...
COMANDO.insert(1,"ssh root@10.159.205.6 'cd /opt/PLAO; git pull; do kill -9 $pid; done ;python3 /opt/PLAO/PLAO_client.py 10.159.205.10 openstack1 10.159.205.6 > /dev/null 2>&1 &'")
...
#; for pid in $(ps -ef | grep 'PLAO_client.py' | awk '{print $2}')
