...
COMANDO.insert(2,'ssh root@10.159.205.12 '+ "'"+'for pid in $(ps -ef | grep "PLAO_client.py" | awk '+"'"+'{print $2})'+"'"+'; do kill -9 $pid; done ; cd /opt/PLAO; git pull; python3 PLAO_client.py 10.159.205.10 openstack1 10.159.205.6 > /dev/null 2>&1 &' +"'")
