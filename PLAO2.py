...
def SelectVnfInstanciatedExists(cod,vnf):
    selectifExists=Vnf_Instanciateds.select().join(Status_Vnf_Instanciateds).where((Vnf_Instanciateds.id_osm_vnf_instanciated==cod)&(Vnf_Instanciateds.name_osm_vnf_instanciated==vnf)).execute()
